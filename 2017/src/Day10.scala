...
object Day10 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    of 64 rounds, using the same length sequence in each round. The current position
    ...
    to the hexadecimal numbers 40, 07, ff, and so the first six characters of
    the hash would be 4007ff. Because every Knot Hash is sixteen such numbers,
